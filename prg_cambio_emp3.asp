...
IF request.form("cbxine") = "on" then arreglo3(29)= 1 end IF
IF request.form("cbxdomicilio") = "on" then arreglo3(30)= 1 end IF
IF request.form("cbxpagare") = "on" then arreglo3(31)= 1 end IF
IF request.form("cbxcontrato") = "on" then arreglo3(32)= 1 end IF
...
arreglo2(29, 0) ="ife"
arreglo2(30, 0) ="comp_dom"
arreglo2(31, 0) ="pagare"
arreglo2(32, 0) ="contrato"
...
arreglo2(26, 1) ="CAMBIO DE NUM. FONACOT"
arreglo2(27, 1) ="CAMBIO DE INFONAVIT"
arreglo2(28, 1) ="CAMBIO DE CORREO PERSONAL"
arreglo2(29, 1) ="CAMBIO DE INE"
arreglo2(30, 1) ="CAMBIO DE COMPROBANTE DOMICILIO"
arreglo2(31, 1) ="CAMBIO DE PAGARE"
arreglo2(32, 1) ="CAMBIO DE CONTRATO"
